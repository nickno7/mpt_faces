...
if __name__ == "__main__":
    predictions_epoch1 = np.array([[0.1, 0.8, 0.1], [0.3, 0.4, 0.3], [0.5, 0.3, 0.2], [0.7, 0.2, 0.1], [0.2, 0.5, 0.3], [0.1, 0.3, 0.6]])
    groundtruth_epoch1 = np.array([1, 0, 2, 0, 0, 0])

    predictions_epoch2 = np.array([[0.7, 0.2, 0.1], [0.2, 0.5, 0.3], [0.1, 0.9, 0.6], [0.7, 0.9, 0.1], [0.2, 0.9, 0.3], [0.1, 0.9, 0.6]])
    groundtruth_epoch2 = np.array([2, 1, 0, 0, 0, 0])
    ...
    predictions_epoch1 = np.array([np.argmax(p) for p in predictions_epoch1])
    predictions_epoch2 = np.array([np.argmax(p) for p in predictions_epoch2])
    print(balanced_accuracy_score(np.hstack((groundtruth_epoch1, groundtruth_epoch2)), np.hstack((predictions_epoch1, predictions_epoch2))))